...
const ErrorDialog: FC<Props> = ({ setErrorDialogToggle, errorDialogData }) => {
  return (
    <>
      ...
      />
      <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[28rem] h-60 bg-Background flex flex-col p-4">
        ...
        <div className="text-sm italic pt-2">{errorDialogData.errorData}</div>
